          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-3.5 bg-white border border-slate-200 rounded-xl text-slate-900 text-sm focus:outline-none focus:ring-4 focus:ring-blue-600/5 focus:border-blue-600 transition-all placeholder:text-slate-300"
            ...
            <div className="space-y-4 pt-4">
              <p className="text-xs text-slate-400 leading-relaxed text-center">
                By logging in, you agree to our <a href="#" className="text-blue-600 font-bold hover:underline">Terms of Service</a> and <a href="#" className="text-blue-600 font-bold hover:underline">Privacy Policy</a>
              </p>
            </div>
          </form>
        </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#7065f0] p-12 items-center justify-center relative">
        ...
        <div className="relative z-10 w-full max-w-[620px] h-[760px] bg-white/10 backdrop-blur-md border border-white/20 rounded-[48px] p-12 flex flex-col shadow-2xl animate-in zoom-in duration-1000">
          <div className="flex-1 flex flex-col items-center justify-center relative">
             {/* Simple modern lamp graphic or similar if needed, or just the illustration */}
